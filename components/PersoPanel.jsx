            ...
            <div className="modal_information">
                ...
                <div className="modal_content_information">
                    <div className="left_content fs_large">
                        <p>
                            Mon objectif est avant tout de réaliser le votre, que ce soit pour <span className="bold"> la perte de poid</span>,<span className="bold"> la remise en forme</span>,{" "}
                            <span className="bold">la prise de masse</span>, nous analyserons ensemble vos objectifs pour{" "}
                            <span className="bold">construire un programme entièrement adapté à vos besoins.</span>
                        </p>

                        <p>
                            Votre programme sera entièrement <span className="bold">évolutif et adapté à vos progrès et votre évolution.</span>
                        </p>

                        <p>
                            Coaching adapté à tous, <span className="bold">Débutant</span>, <span className="bold">Professionnel</span>, <span className="bold">Sénior</span> ou{" "}
                            <span className="bold">PMR (personne à mobilité réduite)</span>.
                        </p>

                        <p>
                            Un premier bilan gratuit, qui prendra en compte vos antécédents sportif, votre forme globale ainsi que vos objectifs, nous permettra de construire ensemble votre programme
                            d&apos;entrainement
                        </p>
                    </div>
