            ...
            <div className="modal_information">
                ...
                <div className="modal_content_information">
                    <div className="left_content fs_small">
                        <p>
                            {" "}
                            L’activité physique pendant la grossesse permet de mieux vivre les modifications corporelles, elle diminue la fatigue et l’anxiété, limite le surplus de poids ainsi que le
                            diabète gestationnel puis prévient les douleurs liées au changement de posture.
                        </p>
                        ...
                        <ul>
                            <li>
                                <span className="bold">Fitness pré/post natal</span> : un mélange d’exercices cardiovasculaire et de renforcement musculaire ciblés sur les muscles sollicités pendant
                                et après la grossesse. Avec un programme adapté au fur et à mesure des trimestres,vous garderez la forme tout au long de votre grossesse et bien après..
                            </li>
                            <li>
                                <span className="bold">Pilates pré/post natal </span>: Le Pilate est une activité physique adaptée à la femme enceinte par la pratique d’une méthode de gym douce
                                centrée sur les muscles profonds et du périnée. Cela limite donc les lésions sur celui-ci en préservant sa tonicité, parfait pour les futures mamans qui veulent
                                s’exercer en douceur
                            </li>
                            <li>
                                <span className="bold">Zumba pré natal </span>: Au même titre que le fitness, c&apos;est un exercice cardiovasculaire qui permet de garder la forme et la mobilité tout
                                en s&apos;éclatant en dansant.{" "}
                            </li>
                        </ul>
                    </div>
