    ...
    return (
        <div className="coaching_panel">
            ...
            <div className="window_container">
                <div className="window individual" data-window="individual" onClick={openPanel}>
                    <div className="window_title" data-window="individual">
                        Individuel
                    </div>
                ...
                <div className="window collective" data-window="collective" onClick={openPanel}>
                    <div className="window_title" data-window="collective">
                        Collectif
                    </div>
                    <div style={{ width: "25rem", height: "20rem" }}>
                        <Image
